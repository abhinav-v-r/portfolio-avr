...
# Abhinav V R - Portfolio

A modern, minimalist portfolio template built with Astro and Tailwind CSS.

> **📬 Connect & Share!**  
> For questions and updates, feel free to reach out on [**X (Twitter)**](https://x.com/abhinavVR).  
...
The portfolio uses [Tabler Icons](https://tabler.io/icons) for all icons.
...
```
git clone https://github.com/abhinav-v-r/portfolio-avr.git
cd devportfolio
npm install
```
...
Feel free to reach out on [X (Twitter)](https://x.com/abhinavVR) if you have any questions or need help.
